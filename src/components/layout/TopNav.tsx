      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', alignItems: 'center', height: isMobile ? 44 : 48 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 9, flexShrink: 0, minWidth: 150 }}>
            <img src="/logo.png" alt="JoyMarketing" style={{ height: 30, width: 'auto', flexShrink: 0, objectFit: 'contain' }} />
            <span style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 20px 16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                <img src="/logo.png" alt="JoyMarketing" style={{ height: 30, width: 'auto', objectFit: 'contain' }} />
                <span style={{
                  display: 'inline-flex', alignItems: 'center', gap: 5,
                  fontWeight: 700, fontSize: 11.5, letterSpacing: '1.2px',
                  padding: '4px 11px', lineHeight: 1.3,
